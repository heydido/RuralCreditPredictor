...
def upload_file(local_path, remote_path):
    try:
        ...
        s3 = get_repo_bucket_client("heydido/RuralCreditPredictor")
        ...
        s3.upload_file(
            Bucket="RuralCreditPredictor",  # name of the repo
...
if __name__ == "__main__":
    # Upload a file
    upload_file("notebook/data/RuralCreditData.csv", "raw_data/RuralCreditData.csv")
